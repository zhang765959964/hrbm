...
import com.xunfeng.core.mybatis.BaseMyBatisDao;
import com.xunfeng.core.mybatis.IbatisSql;
...
* @Description: 数据库操作基类
* @author wanghan 
* @createDate 2015年4月24日-上午9:42:03 
* @version V1.0   
*/
...
//			}
	 ...
	 *
	 */
	public List getObjectList(String sqlKey,Object params,PageBean pageBean)
	{
		String statementName= getIbatisMapperNamespace() + "." + sqlKey;
//		PageBean pageBean = queryFilter.getPageBean();
//		Object params=queryFilter.getFilters();
	...
	public List getListForm(String sqlKey,QueryFilter queryFilter)
	{	
		String statementName= getIbatisMapperNamespace() + "." + sqlKey;
		PageBean pageBean = queryFilter.getPageBean();
		Object params=queryFilter.getFilters();
	...
	public List getListCustomPage(String sqlKey,String countsqlKey,QueryFilter queryFilter)
	{	
		String statementName= getIbatisMapperNamespace() + "." + sqlKey;
		PageBean pageBean = queryFilter.getPageBean();
		Object params=queryFilter.getFilters();
		...
		if(pageBean.isShowTotal()){
			...
			//log.info(ibatisSql.getSql());
			//取得返回数量
			int totalCount=getSqlSessionTemplate().selectOne(countsqlKey, filters);
			
			pageBean.setTotalCount(totalCount);
		}
//		RowBounds rowBounds=new RowBounds(pageBean.getFirst(),pageBean.getPageSize());
		filters.put("rowFirst", pageBean.getFirst());
		filters.put("rowLast", pageBean.getLast());
		List list =  getSqlSessionTemplate().selectList(statementName, filters);
		return list;
	}
