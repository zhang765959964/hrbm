...
* @Description: 字符串操作类
* @author wanghan 
* @createDate 2015年4月23日-上午11:24:20 
* @version V1.0   
*/
public class StringUtil {
	...
	/**
	 * 格式化带参数的字符串，如 /param/detail.xf?a={0}&b={1}
	 * 
	 * @param message
	 * @param args
	 * @return
	...
	public static String getPreParamWildcard(String valueCon) {
		if(StringUtils.isBlank(valueCon)){
			return "";
		}
		String[] valueConArray =valueCon.split(",");
		StringBuffer sb=new StringBuffer();
		sb.append("(");
		for(int i=0;i<valueConArray.length;i++){
			if(i==0){
				sb.append("?");	
			}else{
				sb.append(",?");
