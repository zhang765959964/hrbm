 ...
 * 
 * @author 王晗<br/>
 * @CreateDate: 2014年8月11日<br/>
 * @LastModitor: 王晗<br/>
 * @LastModitiedDate: 2014年8月11日<br/>
 * @Version 1.0<br/>
 * @Copyright (c) 2014 河南新创元<br/>
...
public class JSonUtils {
	...
	/**
	 *  把JavaBean转换为json字符串  (1)普通对象转换：toJson(Student) 
	 * (2)List转换：toJson(List)  (3)Map转换:toJson(Map) 我们发现不管什么类型，都可以直接传入这个方法
	 * 
	 * 
	 * 
	 * 
