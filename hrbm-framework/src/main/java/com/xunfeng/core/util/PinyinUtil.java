...
* @Description: 中文字符处理工具 
* @author wanghan 
* @createDate 2015年4月23日-上午11:27:58 
* @version V1.0   
*/
public class PinyinUtil {
	...
	public static void main(String[] args) {
		...
		String str = "王晗";
		info("小写输出：" + getPinyinToLowerCase(str));
		info("大写输出：" + getPinyinToUpperCase(str));
		info("首字母大写输出：" + getPinyinFirstToUpperCase(str));
		info("返回中文的首字母输出：" + getPinYinHeadChar(str));
		info("返回中文的首字母并过滤特殊字符输出：" + getPinYinHeadCharFilter(str));
