...
import com.xunfeng.core.annotion.query.Table;

/**  
* @company: 河南讯丰信息技术有限公司 
* @Description: 构建允许动态构建的搜索实体  在程序启动时，程序自动去查找
* @author wanghan 
* @createDate 2015年4月23日-上午10:52:00 
* @version V1.0   
*/
	...
	public void constractSearchTableList() throws IOException,
		...
		for (Class<?> cls : tableList) {
			...
			for (Field field : fields) {
				com.xunfeng.core.annotion.query.Field qField = field
						.getAnnotation(com.xunfeng.core.annotion.query.Field.class);
				if (qField != null) {
