    ...
    $('#cropForm').bootstrapValidator({
        ...
        feedbackIcons: {
          ...
          fields: {
    	      ...
    	      var acb200 = parentIframe.getParentSelectValues();
    	       $("#acb200").val(acb200);
               e.preventDefault();
               var $form = $(e.target);
...
<body>
 <form:form modelAttribute="cropForm" method="post" action="${ctx}/business/jobfair/corpPosition/freezeCorpPublicPosition.xf">
  <div class="modal-body overflow-visible reportWrap">
      <div class="row mhyPhotoDiv"  >
						<div  style="margin: 0 auto;width: 210px;">
						<label for="inputError" style="margin-right:5px;">冻结原因:</label>
						<div style="float:left;">
						<form:hidden path="acb200"/>
