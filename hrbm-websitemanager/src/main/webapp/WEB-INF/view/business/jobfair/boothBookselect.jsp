	...
	<script type="text/javascript">
	 ...
	 function  approve(approveFlag){
		 ...
		 var acb200=$("#acb200").val();
			 $.ajax({ url: '${ctx}/business/jobfair/boothBook/approve.xf',
				 data:{approveFlag:approveFlag,cczy01:cczy01,acb210:acb210},
				 dataType:'json',
	...
	<div id="dg_toolbar" style="padding: 5px 5px;">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton tb_destory" onclick="closeItem()" iconCls="icon-clear">关闭</a>
					...
					<table class="formTable">
						<tr>
						 <td class="formHead" colspan="2">摊位预定基本信息</td>
						</tr>
					</table>
					...
					<fieldset>
						...
						<table class="formTable">
							...
							<tr>
								...
								<td class="formInput"><input class="easyui-textbox" data-options="readonly:true" type="text" name="acb333" value='<fmt:formatDate value="${jobFairInfo.acb333 }" pattern="yyyy-MM-dd" />'/></td>
								<td class="formTitle">结束日期： </td>
								<td class="formInput"><input class="easyui-textbox" data-options="readonly:true" type="text" name="acb334" value='<fmt:formatDate value="${jobFairInfo.acb334 }" pattern="yyyy-MM-dd" />'/></td>
							</tr>
						</table>
						</form:form>
					</fieldset>
					...
					<c:if test="${! empty corpPositionPublish}">
						<fieldset>
							<legend>企业信息</legend>
							<form:form modelAttribute="corpPositionPublish" method="post" >
								<input id="acb200" type="hidden" name="acb200" value="${corpPositionPublish.acb200}"/>
								<table class="formTable">
									<tr>
									...
									<tr>
										...
										<table class="formTable"><tr><td style="text-align: left;width:500px">${corpPositionPublish.acb206}</td></tr></table>
										</td>
									</tr>
								</table>
							</form:form>
