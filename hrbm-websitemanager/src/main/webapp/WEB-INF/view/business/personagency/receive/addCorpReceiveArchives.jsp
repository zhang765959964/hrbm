...
<body>
	...
	<div class="moduleWrapNobg">
		<div class="moduleTit dbToggle">
			...
			<span class="fr mgr15">
				<a  class="btnToggle" href="javascript:collapseWrap('collapseWrap',this)">
		...
		<div class="moduleCont dnn" id="familyWrap">
			<div class="row">
				<label class="col-xs-3 col-sm-2" for="inputError">婚姻状况:</label>
                   <div class="col-xs-9 col-sm-2">
					<xf:select tableName="TAB_MARRIAGE" valueField="code" textField="name" name="jiaTingForm.faMarriage" 
						 value='${receiveArchivesPersonForm.jiaTingForm.faMarriage}' hasDefault="0" selectClass="form-control"></xf:select>
				</div>
   	...
   	<div class="bottomBtn">
   		...
   		<div class="floatBtn">
			...
			<a href="javascript:void(0)" role="button" class="btn btn-danger"><i class="icon-trash"></i>照片删除</a>
	   		...
	   		<a role="button" class="btn btn-info" href="javascript:closeItem()"><i class="icon-remove"></i>关闭</a>
   		</div>
   	</div>
 </form:form>
                        ...
                        bootbox.alert({ 
                            ...
                            callback: function(){ 
            			    	...
            			    	if(parentIframe){
            			    		...
            			    		parentIframe.refreshArchiveCount();
