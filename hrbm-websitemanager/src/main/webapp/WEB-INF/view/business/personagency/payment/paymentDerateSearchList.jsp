...
<script type="text/javascript" src="${ctx}/js/business/personagency/payment/paymentDerateSearchList.js?v=201701221"></script>
</head>
<body>
	<div class="container-fluid">
		<div class="tabable row">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
				<li class="active"><a data-toggle="tab" href="#perBase">个人减免查询</a></li>
				<li><a data-toggle="tab" href="#perEdu">单位减免查询</a></li>
			</ul>
			<div class="tab-content">
				<div id="perBase" class="tab-pane in active">
					<div class="moduleWrap mgt5">
						<div class="moduleTit">
							<span claass="fl"><i class="icon-minus icon-rotate-90"></i>查询条件</span>
						</div>
							...
							<form id="searchForm">
								<div class="row">
									...
									<div class="col-xs-9 input-group col-sm-2">
										<input class="form-control date-picker dp date" format="YYYY-MM-DD" autoUpdateInput="false" name="Q_beginreceiveDate_DL" type="text" placeholder="请选择日期" />
									...
									<div class="col-xs-9 input-group col-sm-2">
										<input class="form-control date-picker dp date" format="YYYY-MM-DD" autoUpdateInput="false" name="Q_endreceiveDate_DG" type="text" placeholder="请选择日期" />
										<span class="input-group-addon"> <i class="icon-calendar bigger-110"></i>
										</span>
									</div>
								...
								<div class="row highCondition dnn">
									...
									<div class="col-xs-9 col-sm-2">
										<input class="form-control" type="text" name="fdConfirmsName" data-placement="bottom" />
									</div>
									<label class="col-xs-3 col-sm-2" for="inputError">财务经办机构:</label>
									<div class="col-xs-9 col-sm-2">
										<input class="form-control" type="text" name="fdConfirmsOrgName" data-placement="bottom" />
									</div>
								...
								<div class="row">
									<div class="col-sm-12 mgb20 tar pdx20">
										...
										<a href="javascript:void(0)" class="btn btn-success highSearch">
					...
					<div class="moduleWrap mgt5">
						<div class="moduleTit">
							<span claass="fl"><i class="icon-minus icon-rotate-90"></i>查询结果</span>
						</div>
						<div class="moduleCont">
							<div class="row">
								<div class="mgy10">
					...
					<div class="moduleWrap mgt5">
						...
						<div class="moduleCont">
							<form id="searchCorpForm">
								...
								<div class="row">
									<div class="col-sm-12 mgb20 tar pdx20">
										<a href="#" role="button" onclick="doCorpSearch()" class="btn btn-primary btn-border1">
											<i class="icon-search"></i>查询
										</a>
										<a href="javascript:resetForm('searchCorpForm')" role="button" class="btn btn-info">
											<i class="icon-repeat"></i>重置
										</a>
									</div>
								</div>
