...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/archive/archiveLendList.js"></script>
</head>
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					...
					<div class="dataTableWrap">
						<table id="archiveLendList"  class="datagridClass"></table>
			...
			<div class="bottomBtn">
		   		<div class="h50">&nbsp;</div>
		   		<div class="floatBtn">
			   		<a href="javascript:void(0)" role="button" class="btn btn-info" onclick="lendComfirm()"><i class="icon-ok"></i>调出确认</a>
					<a href="javascript:void(0)" role="button" class="btn btn-yellow" onclick="refresh()"><i class="icon-refresh"></i>刷新列表</a>
		   		</div>
		   	</div>
		</div>
	</div>
