...
<script type="text/javascript">
	$(function() {
			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 ...
						 $("#normalArchivesResultList").load("${ctx}/business/personagency/storage/storage/normalResultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
		...
		$("#normalArchivesResultList").load("${ctx}/business/personagency/storage/storage/normalResultList.xf");
	})
</script>
</head>
<body>
	<div class="container-fluid">
		...
		<div id="normalArchivesResultList"></div>	
	</div>			
</body>
</html>