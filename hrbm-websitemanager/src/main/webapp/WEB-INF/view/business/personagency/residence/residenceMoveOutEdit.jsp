...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/residence/residenceMoveOutEdit.js?verson=20161212"></script>
</head>
<body>
<form:form modelAttribute="residenceMoveOutForm" method="post" action="${ctx}/business/personagency/residence/residenceMoveOut/save.xf">
	<div class="container-fluid">
		...
		<div class="moduleCont change-bg-iframe">			
			    ...
			    <div class="row">
					...
					<div class="col-xs-9 col-sm-input required">
						<xf:select  tableName="RSDA_TAB_RESIDENCE_STATUS" valueField="code" textField="name" name="residenceStatus"  
									value='${residenceMoveOutForm.residenceStatus}' valueCon="2" selectClass="form-control"></xf:select>
					</div>
                ...
                <div class="row"> 		
                    <label class="col-xs-3 col-sm-label" for="inputError"><em>*</em>迁移日期:</label>
					<div class="col-xs-9 input-group col-sm-input">
					  	<div class="input-group row required">
                           	<form:input  class="form-control" type="text"  path="outDate" placeholder="请选择日期"></form:input>
                           	<span class="input-group-addon">
                               	<i class="icon-calendar bigger-110"></i>
                           	</span>
                         </div>
                    </div>
					<label class="col-xs-3 col-sm-label" for="inputError"><em>*</em>迁移地址:</label>
					<div class="col-xs-12 col-sm-two-col required">
