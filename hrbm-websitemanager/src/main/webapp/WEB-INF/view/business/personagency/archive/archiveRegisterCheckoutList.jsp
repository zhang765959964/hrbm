...
<script type="text/javascript">
	$(function() {
			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 ...
						 $("#archiveRegisterCheckoutList").load("${ctx}/business/personagency/archive/archiveCheckout/registerResultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
		...
		$("#archiveRegisterCheckoutList").load("${ctx}/business/personagency/archive/archiveCheckout/registerResultList.xf");
	})
...
<body>
	<div class="container-fluid">
		...
		<div id="archiveRegisterCheckoutList"></div>
	</div>
</body>
</html>