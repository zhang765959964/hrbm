...
<script type="text/javascript">
	$(function() {
			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 bootbox.alert("当前档案状态【已经调出】！不能操作！");
					 }else if(data.ARCHIVESTATUS==3){
						 bootbox.alert("当前档案状态【已经死亡】！不能操作！");
					 }else{
						 $("#changerAndTransferList").load("${ctx}/business/personagency/social/changeAndTransfer/resultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
		...
		$("#changerAndTransferList").load("${ctx}/business/personagency/social/changeAndTransfer/resultList.xf");
	})
</script>
</head>
<body>
	<div class="container-fluid">
		...
		<div id="changerAndTransferList"></div>	
	</div>			
</body>
</html>