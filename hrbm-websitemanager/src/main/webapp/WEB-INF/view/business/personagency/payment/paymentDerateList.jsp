...
<script type="text/javascript" src="${ctx}/js/business/personagency/payment/paymentDerateList.js?version=201611031049"></script>
<script>
$(function(){
	/**
	 初始化表格显示
	*/
	...
	$("#paymentRecordList").jqGrid({
           mtype: "GET",
		   url:CTX+'/business/personagency/payment/derate/listJson.xf?fkPersonId=${personId}',
		   styleUI : 'Bootstrap',
           datatype: "json",
           colModel: columns,
		   viewrecords: true,
