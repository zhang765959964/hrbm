...
<script type="text/javascript">
	$(function() {
			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 bootbox.alert("当前档案已经调出！暂不能代理手册登记！");
					 }else{
						 $("#proxyManualResultList").load("${ctx}/business/personagency/receive/proxyManual/resultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
		...
		$("#seccard").seccard({callBack:function(personId,data){
		 ...
		 $("#proxyManualResultList").load("${ctx}/business/personagency/receive/proxyManual/resultList.xf");
	})
</script>
</head>
<body>
	<div class="container-fluid">
		...
		<div id="proxyManualResultList"></div>
	</div>
</body>
</html>