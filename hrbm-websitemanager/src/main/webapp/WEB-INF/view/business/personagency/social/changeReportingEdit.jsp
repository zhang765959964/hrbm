...
<html>
<head>
	<title>编辑 个人社保变更申报记录表</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <%@include file="/commons/include/commonInc.jsp" %>
    <script type="text/javascript" src="${ctx}/js/business/personagency/social/changeReportingEdit.js"></script>
</head>
<body>
<form:form modelAttribute="changeReportingForm" method="post" action="${ctx}/business/personagency/social/changeReporting/save.xf">
			...
			<div class="moduleWrapNobg change-bg-iframe">
				<div class="moduleCont">
					...
					<div class="row">	
						...
						<label class="col-xs-3 col-sm-label" for="inputError">缴费开始年月:</label>
					    <div class="col-xs-9 input-group col-sm-input">
					    	<div class="input-group row">
						...
						<label class="col-xs-3 col-sm-label" for="inputError">缴费终止年月:</label>
						<div class="col-xs-9 input-group col-sm-input">
							<div class="input-group row">
					...
					<div class="row">									
						<label class="col-xs-3 col-sm-label" for="inputError">停保原因:</label>
							 <div class="col-xs-9 col-sm-input">
					...
					<div class="row">
						...
						<label class="col-xs-3 col-sm-label" for="inputError">停保时间:</label>
						<div class="col-xs-9 input-group col-sm-input">
							<div class="input-group row">
