...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/affair/titleDeclarationList.js"></script>
	<script>
		$(function(){
			xfui.initUi();
			var columns1= [
			...
			$("#titleArchivesList").jqGrid({
		        ...
		        onSelectRow:function(rowId){
			    	  ...
			    	  $('#titleDeclarationList').jqGrid("setGridParam",{datatype: "json",url:'${ctx}/business/personagency/affair/titleDeclaration/listJson.xf?archivesId='+rowData.ID}).trigger("reloadGrid");
			    	  dataJson.archivesId=rowData.ID;
			      }
		    });
			
			$("#titleArchivesList").jqGrid('setFrozenColumns');
		})
		
		function doSearch(){
			var json=$("#searchForm").serializeJson();
			$("#titleArchivesList").jqGrid("clearGridData");	
			$("#titleArchivesList").jqGrid("setGridParam",{datatype: "json",url:'${ctx}/business/personagency/archive/archives/listJson.xf?dataSources=1&archiveStatus=1',postData:json}).trigger("reloadGrid");
		}
	</script>
</head>
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					<div class="dataTableWrap">
						<table id="titleArchivesList" class="datagridClass"></table>
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					<div class="mgy10">
						<a href="javascript:void(0)" onclick="addTitleDeclaration()" role="button" class="btn btn-primary" data-toggle="modal"><i class="icon-plus"></i>添加</a>
						<a href="javascript:void(0)" onclick="editTitleDeclaration()" role="button" class="btn btn-info" data-toggle="modal"><i class="icon-pencil"></i>修改</a>
						<a href="javascript:void(0)" onclick="delTitleDeclaration()" role="button" class="btn btn-danger" ><i class="icon-trash"></i>删除</a>
