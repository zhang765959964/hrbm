...
<script type="text/javascript" src="${ctx}/js/business/personagency/retired/retiredSocialList.js?v=2016121511"></script>
</head>
<body>
		<div class="container-fluid">
					...
					<form id="searchForm">
						<div class="row">
								...
								<div class="col-xs-9 col-sm-2">
									...
									<input  type="hidden"  name="retiredStatus" id="retiredStatus" value="1" />
								</div>
						...
						<div class="row highCondition dnn">				
								...
								<div class="col-xs-9 col-sm-2">
									<input class="form-control" type="text" name="pinyin" data-placement="bottom" />
								</div>
								...
								<div class="col-xs-9 col-sm-2">
									<input class="form-control" type="text" name="Q_retiredSocialUnit_SL" data-placement="bottom" />
								</div>
						</div>
						<div class="row">
				...
				<div class="moduleWrapNob">
					<div class="moduleTit">转社会化批量保存</div>
					<div class="moduleCont">
						<div id="retiredSocial"></div>
					</div> 
				</div>
		</div>
	</div>
