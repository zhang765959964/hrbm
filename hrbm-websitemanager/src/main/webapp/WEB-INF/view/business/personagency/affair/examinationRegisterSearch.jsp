...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/affair/examinationRegisterSearch.js"></script>
</head>
<body>
					...
					<div class="moduleCont">
						<form id="searchForm">
							...
							<div class="row highCondition dnn">
								...
								<label class="col-xs-3 col-sm-2" for="inputError" title="考试类别">考试类别:</label>
								<div class="col-xs-9 col-sm-2">
									<xf:select  tableName="RSDA_TAB_EXAMINATION_TYPE" valueField="code" textField="name" name="Q_examinationType_S" hasDefault="0" valueCon="1,2,3,4" selectClass="form-control"></xf:select>
								</div>
								<label class="col-xs-3 col-sm-2" for="inputError" title="考试细类">考试细类:</label>
								<div class="col-xs-9 col-sm-2">
									<xf:select  tableName="RSDA_TAB_EXAMINATION_TYPE" valueField="code" textField="name" name="Q_examinationMxType_S" hasDefault="0" selectClass="form-control"></xf:select>
								</div>
								<label class="col-xs-3 col-sm-2" for="inputError" title="考试级别">考试级别:</label>
								<div class="col-xs-9 col-sm-2">
									<xf:select  tableName="RSDA_TAB_LEVEL" valueField="code" textField="name" name="Q_examinationLevel_S" hasDefault="0" valueCon="1,2,3" selectClass="form-control"></xf:select>
								</div>
								...
								<label class="col-xs-3 col-sm-2" for="inputError">是否领取成绩单:</label>
								<div class="col-xs-9 col-sm-2">
									<select style='width: 205px' class='easyui-combobox' editable='false' name='Q_isLingExamination_N'>
											<option value="" selected="selected">--请选择--</option>
											<option value="0">否</option>
											<option value="1">是</option>
									</select>
								</div>
								<label class="col-xs-3 col-sm-2" for="inputError">是否领取证书:</label>
								<div class="col-xs-9 col-sm-2">
									<select style='width: 205px' class='easyui-combobox' editable='false' name='Q_isLingZhengshu_N'>
											<option value="" selected="selected">--请选择--</option>
											<option value="0">否</option>
											<option value="1">是</option>
									</select>
								...
								<div class="col-xs-9 col-sm-2">
									<input class="form-control" type="text" name="Q_beginworkingAge_SL" placeholder="" title="" data-placement="bottom" />
								</div>
								<label class="col-xs-3 col-sm-2" for="inputError" title="工作年龄止">工作年龄止:</label>
								<div class="col-xs-9 col-sm-2">
									<input class="form-control" type="text" name="Q_endworkingAge_SL" placeholder="" title="" data-placement="bottom" />
								</div>
