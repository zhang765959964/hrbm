...
<body>
	<div class="container-fluid">
		<div class="row pd-none-wrap">
			<form:form modelAttribute="paymentRecordForm" method="post" action="${ctx}/business/personagency/payment/paymentRecord/save.xf">
				<form:hidden path="pkId"></form:hidden>
				<form:hidden path="fkPersonId"></form:hidden>
				<form:hidden path="fkCorpRecordId"></form:hidden>
				<input id="endDateGB" name="endDateGB" value="${endDateGB}" type="hidden"></input>
				...
				<div class="moduleWrapNobg change-bg-iframe">
					...
					<div class="moduleCont">
						...
						<div class="floatBtn">
							...
							<a href="javascript:void(0)" role="button" class="btn btn-info" id="closeItem">
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/payment/paymentRecordEdit.js?version=2016091818186"></script>
