			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 ...
						 $("#storageArchivesResultList").load("${ctx}/business/personagency/storage/storage/resultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
...
<body>
	<div class="container-fluid">
		...
		<div id="storageArchivesResultList"></div>	
	</div>			
</body>
</html>