...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/business/personagency/storage/specialArchivesSearch.js?verson=20170116"></script>
</head>
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					<div class="mgy10">
						<!-- <a href="javascript:void(0)" role="button" class="btn btn-primary btn-border1" ><i class="icon-print"></i>打印</a> -->
