...
<script type="text/javascript">
	$(function() {
			 ...
			 callBack:function(data){
				 if(!data){
					 ...
					 if(data.ARCHIVESTATUS==2){
						 ...
						 $("#totalResidenceList").load("${ctx}/business/personagency/residence/total/resultList.xf?personId="+ data.PERSONID);
					 }
				 }
			}
		 })
		...
		$("#totalResidenceList").load("${ctx}/business/personagency/residence/total/resultList.xf");
	})
</script>
</head>
<body>
