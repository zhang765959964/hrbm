...
<script type="text/javascript" src="${ctx}/js/business/personagency/retired/retiredBhList.js?v=201701071"></script>
</head>
<body>
	<div class="container-fluid">
		<div class="row">
				...
				<div class="moduleCont">
					<form id="searchForm">
						<div class="row">
							...
							<div class="col-xs-9 col-sm-2">
								<input class="form-control" type="text" id="retiredPeopleNo" name="Q_retiredPeopleNo_SL" data-placement="bottom" />
							</div>
						...
						<div class="row">
							<div class="col-sm-12 mgb20 tar pdx20">
								<a href="#retiredBhList" role="button" onclick="doSearch()" class="btn btn-primary btn-border1">
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					<div class="mgy10">
						<a href="javascript:void(0)" onclick="editBh()" role="button" class="btn btn-info" data-toggle="modal">
							<i class="icon-pencil align-top"></i>修改
						</a>
					...
					<div class="row">
						<div class="col-xs-12">
							<table id="retiredBhList" class="datagridClass"></table>
