...
<script type="text/javascript" src="${ctx}/js/business/personagency/retired/retiredReportList.js?v=201711161"></script>
</head>
<body>
	<div class="container-fluid">
		<div class="row">
					...
					<form id="searchForm">
						...
						<div class="row highCondition dnn">				
							...
							<div class="col-xs-9 input-group col-sm-2">
								<input class="form-control" type="text" id="beginWorkJobDate" name="Q_beginWorkJobDate_DL" data-placement="bottom" />
							...
							<div class="col-xs-9 input-group col-sm-2">
								<input class="form-control" type="text" id="endWorkJobDate" name="Q_endWorkJobDate_DL" data-placement="bottom" />
								<span class="input-group-addon">
									<i class="icon-calendar bigger-110"></i>
								</span>
							</div>
							...
							<div class="col-xs-9 col-sm-2">
								<xf:select textField="name" selectClass="form-control" tableName="RSDA_TAB_RETIRED_GIST" name="retiredYjId"  value="${retiredDeclareForm.retiredYjId}"  valueField="code" hasDefault="0"></xf:select>
							</div>
			...
			<div class="moduleWrapNob">
				...
				<div class="moduleCont">
					...
					<div class="row">
						<div class="col-xs-12">
							<table id="retiredReportList"  class="datagridClass"  ></table>
		...
		<div class="bottomBtn">
				<div class="floatBtn">
					 <a href="javascript:void(0)" role="button" class="btn btn-success" onclick="printRetired()"><i class="icon-barcode"></i>打印退休审批表</a>
				</div> 
		</div>
		</div>
