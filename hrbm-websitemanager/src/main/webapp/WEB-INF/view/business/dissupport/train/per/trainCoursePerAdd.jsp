...
<script type="text/javascript">
               ...
               fields: {
		            ...
		            contactsTel:{
		            	validators: {
		            		...
		            		regexp: {
		            			/* regexp: /(^[0-9]{3,4}\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)|(^0{0,1}1[3|4|5|7|8][0-9]{9}$)/, */
                        ...
                        bootbox.alert({ 
                            ...
                            callback: function(){ 
	           			    	...
	           			    	if(parentIframe){
	           			    		...
	           			    		xfui.open_tabs("开班信息管理","${ctx}/business/dissupport/train/trainCourse/per/list.xf?orgId=${orgId}","开班信息管理"); 
	           			    	}
	                           	closeItem2(); 
                            }
                        })
 ...
 function checkCourseName(obj){
	   ...
	   var courseName=encodeURI(obj);
	    $.ajax({ url: '${ctx}/business/dissupport/train/trainCourse/per/checkName.xf',
...
function ajaxFileUpload(obj) {
     ...
     $.ajaxFileUpload({
         url: '${ctx}/business/dissupport/train/trainCourse/per/fileUpload.xf', 
         type: 'post',
	...
	<div class="main-container mhyBody">
		<div class="container-fluid">
			<div class="mhySearch">
		   		...
		   		<form:form modelAttribute="trainCourseForm" method="post" action="${ctx}/business/dissupport/train/trainCourse/per/save.xf?orgId=${orgId}">
