...
// 																	closeItem();
	...
	function getParentRowDetail() {
		...
		$("#bca112").attr("title", row.BCA112);
		$("#cca112").val(row.CCA112);
		$("#cca114").attr("title", row.CCA114);
		...
		//设置打印数据 
		$("#aac003_print").html(data.AAC003);
		$("#aac003_print2").html(data.AAC003);
		$("#bca112_print").html(row.BCA112);
		$("#bca112_print2").html(row.BCA112);
		$("#aac002_print").attr('value', data.AAC002);
		$("#aac003_print3").attr('value', data.AAC003);
		$("#aad004_print").attr('value', matchdata.aac004);
		$("#aac011_print").attr('value', matchdata.aac011);
		$("#acc20tname_print").attr('value', matchdata.acc20tName);

		$("#aab004_print").attr('value', row.AAB004);
		$("#aab004_print2").html(row.AAB004);
	}
</script>
<style type="text/css">
.bgBr {
		...
		<div class="letterBody">
			<div class="letterTop">
				...
				<div><span id="aab004_print2"></span>:</div>
					...
					<p class="letterMinFont">
						联系电话：<span id="aab390_print"></span>
					</p>
...
<script type="text/javascript">
	...
	function printBody() {
		if(isSave){
			$("#mark_print").attr('value', $("#aae013").val());
