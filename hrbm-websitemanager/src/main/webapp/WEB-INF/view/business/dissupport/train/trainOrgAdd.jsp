			...
			<div class="mhySearch">
		   		...
		   		<form:form modelAttribute="trainOrgForm" method="post" action="${ctx}/business/dissupport/train/trainOrg/save.xf">
				    ...
				    <input type="hidden" id="editOrgName" name="editOrgName" value="${editOrgName}"/>
		   			<div class="mhySearchInput mhyInputDiv" style="">
		   					<div class="row">
								...
								<div class="col-xs-9 col-sm-2">
									<form:input class="form-control" type="text" id="orgPublishName" path="orgPublishName" value="${trainOrgForm.orgPublishName}" maxlength="100"></form:input>
								</div>
		   				...
		   				<div class="row">
		   					...
		   					<div class="col-xs-10 col-sm-10">
		   					    <form:input class="form-control" type="text" id="orgAddr" path="orgAddr" value="${trainOrgForm.orgAddr}" placeholder="地址长度不能超出100字" maxlength="100" ></form:input>
						    </div>
		   				</div>
