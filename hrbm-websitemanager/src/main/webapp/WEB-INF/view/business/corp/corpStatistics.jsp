...
<script>
	$(function() {
		...
		$('#jobFairInfoList').bootstrapTable({
			url : '${ctx}/business/corp/corp/listStatisticsJson.xf',
			columns : columns,
			method : "post",
	...
	function statisticsChange(obj){
		var datanamevalues = [];
		var title = "单位信息数据统计图";
	 	$.ajax({ url: '${ctx}/business/corp/corp/listStatisticsChartsJson.xf',
	 		async : false,
	 		data:{'groupvalue':obj},
	...
	<div class="container-fluid">
		<div class="mhyBody">
			...
			<div class="mhyMain">
				...
				<div class="mhyInfo">
					<table id="jobFairInfoList" class="datagridClass tableClassNoworks" ></table>
				</div>
			</div>
		</div>
	</div>
