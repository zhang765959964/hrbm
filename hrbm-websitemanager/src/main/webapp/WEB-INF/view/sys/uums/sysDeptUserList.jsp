...
// 					   {field:'status',title:'Id号',checkbox:'true',width:'5%',align:'center'},
		                {field:'cczh01',title:'账户名',width:'15%',align:'center'},
	      	        	...
	      	        	{field:'dep002',title:'所属部门',width:'20%',align:'center'}
// 		        	    ,{field:'aac001',title:'个人编号',width:150,align:'center'}	        	        
		        	    ]];
		$('#userList').bootstrapTable({
		    url:'${ctx}/sys/uums/sysDept/listUsersJson.xf?dep001=${dep001}',
		    columns:columns,
		    method:"post",
	...
	function addRoleUser(){	
		...
		xfui.open_dialog({    
		    ...
		    closed: false,    
		    cache: false,    
		    url: "${ctx}/sys/uums/sysDept/addDeptUsers.xf?dep001="+dep001+"&acd200="+acd200,
		    modal: true   
		})
    }
	function refresh(){
...
<body>
	...
	<div class="mhyBody">
				...
				<div class="mhyTitle">查询条件</div>
						<form id="searchForm" class="mhySearchInput">
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-2"></div>
									...
									<div class="col-xs-12 col-sm-4 marginbottom20 mhySearchRight">
						...
						<div class="mhyInfo">
						<div class="mgy10">
							<a href="javascript:void(0)" onclick="addRoleUser()" role="button" class="btn btn-primary mhyBtnLeft" data-toggle="modal"><i class="icon-plus"></i>添加部门人员</a>
							</div><div class="mhyConter">
						  <table id="userList" class="datagridClass tableClassNoworks"></table>
						</div>
						</div>
					</div>
   					 <input type="hidden" id="dep001" value='${dep001}'/></div></div>
</body>
</html>