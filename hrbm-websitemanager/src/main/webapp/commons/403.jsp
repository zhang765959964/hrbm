<%@page import="com.xunfeng.core.web.util.RequestUtil,org.springframework.security.access.AccessDeniedException"  pageEncoding="UTF-8" isErrorPage="true" %>
<%
	...
	<table  border="0" align="center" cellpadding="0" cellspacing="0" width="450">
		  ...
		  <tr>
		    <td height="200" align="center" valign="top" background="<%=basePath%>/styles/default/images/error/error_bg.jpg">
		    	...
		    	<tr>
		    		<td style="text-align: center;"><img src="<%=basePath%>/styles/default/images/error/error_sorry.png" /></td>
		    	</tr>
		        <tr>
