...
//			long maxSize = ((Long) conf.get("maxSize")).longValue();
			...
			UniqueIdUtilInterf uniqueIdUtil=(UniqueIdUtilInterf)AppUtil.getBean("uniqueId");
...
//					physicalPath, maxSize);
			...
			String url=FileWebDavUtil.uploadFile("/news/", savePath, uniqueIdUtil.genId("")+suffix, is);
//			is.close();
