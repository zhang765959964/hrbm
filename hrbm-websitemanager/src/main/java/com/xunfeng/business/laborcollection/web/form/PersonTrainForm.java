...
* @Description: 培训经历表 Form对象
* @author:wangyanyan
* @createDate 2016-06-25 17:41:23 
* @version V1.0   
*/
public class PersonTrainForm extends BaseForm<PersonTrain>
{
	// 培训经历编号
	...
	{
		if (!(object instanceof PersonTrainForm)) 
		{
			return false;
		}
		PersonTrainForm rhs = (PersonTrainForm) object;
