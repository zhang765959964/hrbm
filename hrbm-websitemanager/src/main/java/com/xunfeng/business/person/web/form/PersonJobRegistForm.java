...
* @Description: 个人求职登记表 Form对象
* @author:wanlupeng
* @createDate 2016-08-09 16:47:33 
* @version V1.0   
*/
public class PersonJobRegistForm extends BaseForm<PersonJobRegist>
{
	// 个人求职登记ID
	...
	public Long getDiv001() 
	{
   	...
   	public String getAcc20() {
		return this.acc20;
	}
	public void setAcc20(String acc20) {
		this.acc20 = acc20;
	}
	/**
	...
	{
		if (!(object instanceof PersonJobRegistForm)) 
		{
			return false;
		}
		PersonJobRegistForm rhs = (PersonJobRegistForm) object;
