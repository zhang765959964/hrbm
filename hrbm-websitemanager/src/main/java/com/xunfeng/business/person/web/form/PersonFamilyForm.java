...
* @Description: 人员家庭关系表 Form对象
* @author:wanlupeng
* @createDate 2016-07-07 09:13:01 
* @version V1.0   
*/
public class PersonFamilyForm extends BaseForm<PersonFamily>
{
	// 主键ID
	protected Long  id;
	// 配偶姓名
	...
	{
		if (!(object instanceof PersonFamilyForm)) 
		{
			return false;
		}
		PersonFamilyForm rhs = (PersonFamilyForm) object;
