...
* @version V1.0   
*/
public class PersonWorkExpceForm extends BaseForm<PersonWorkExpce>
{
	// 工作经历编号
	...
	{
		if (!(object instanceof PersonWorkExpceForm)) 
		{
			return false;
		}
		PersonWorkExpceForm rhs = (PersonWorkExpceForm) object;
