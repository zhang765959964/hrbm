...
* @Description: 开班类型表 Form对象
* @author:Wang.CS
* @createDate 2016-05-23 09:29:51 
* @version V1.0   
*/
public class TrainCourseTypeForm extends BaseForm<TrainCourseType>
{
	// 开班类型编号
	...
	{
		if (!(object instanceof TrainCourseTypeForm)) 
		{
			return false;
		}
		TrainCourseTypeForm rhs = (TrainCourseTypeForm) object;
