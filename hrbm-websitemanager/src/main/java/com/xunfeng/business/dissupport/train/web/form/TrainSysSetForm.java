...
* @Description: 培训系统设置表 Form对象
* @author:Wang.CS
* @createDate 2016-05-23 09:31:57 
* @version V1.0   
*/
public class TrainSysSetForm extends BaseForm<TrainSysSet>
{
	// 系统配置自动编号
	...
	{
		if (!(object instanceof TrainSysSetForm)) 
		{
			return false;
		}
		TrainSysSetForm rhs = (TrainSysSetForm) object;
