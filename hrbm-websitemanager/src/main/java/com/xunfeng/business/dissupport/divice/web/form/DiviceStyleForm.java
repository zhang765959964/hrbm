...
* @Description: 样式表 Form对象
* @author:wanghan
* @createDate 2016-07-27 17:06:34 
* @version V1.0   
*/
public class DiviceStyleForm extends BaseForm<DiviceStyle>
{
	// 型号表编号seq_sb_ys
	...
	{
		if (!(object instanceof DiviceStyleForm)) 
		{
			return false;
		}
		DiviceStyleForm rhs = (DiviceStyleForm) object;
