package com.xunfeng.business.dissupport.train.web.form;
...
* @Description: 培训报名表 Form对象
* @author:Wang.CS
* @createDate 2016-05-23 09:31:31 
* @version V1.0   
*/
public class TrainSignUpForm extends BaseForm<TrainSignUp>
{
	// 报名编号
	...
	{
		if (!(object instanceof TrainSignUpForm)) 
		{
			return false;
		}
		TrainSignUpForm rhs = (TrainSignUpForm) object;
		return new EqualsBuilder()
		.append(this.pxSignUpId, rhs.pxSignUpId)
	...
	public String toString() 
	{
		...
		.append("pxSignUpId", this.pxSignUpId) 
