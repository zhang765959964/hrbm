...
* @Description: 开班信息表 Form对象
* @author:Wang.CS
* @createDate 2016-05-22 09:25:59 
* @version V1.0   
*/
public class TrainCourseForm extends BaseForm<TrainCourse>
{
	// 开班编号
	...
	{
		if (!(object instanceof TrainCourseForm)) 
		{
			return false;
		}
		TrainCourseForm rhs = (TrainCourseForm) object;
