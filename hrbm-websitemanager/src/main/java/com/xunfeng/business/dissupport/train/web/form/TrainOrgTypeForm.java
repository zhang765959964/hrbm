...
* @Description: 培训机构类型表 Form对象
* @author:Wang.CS
* @createDate 2016-05-23 09:31:02 
* @version V1.0   
*/
public class TrainOrgTypeForm extends BaseForm<TrainOrgType>
{
	// 培训机构类型编号
	...
	{
		if (!(object instanceof TrainOrgTypeForm)) 
		{
			return false;
		}
		TrainOrgTypeForm rhs = (TrainOrgTypeForm) object;
