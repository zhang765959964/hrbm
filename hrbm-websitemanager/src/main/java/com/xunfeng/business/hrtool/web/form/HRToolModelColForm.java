...
* @Description: 工具箱模板栏目表 Form对象
* @author:wanghan
* @createDate 2016-03-09 10:48:16 
* @version V1.0   
*/
public class HRToolModelColForm extends BaseForm<HRToolModelCol>
{
	// 主键
	protected Long  id;
	// 名称
	...
	{
		if (!(object instanceof HRToolModelColForm)) 
		{
			return false;
		}
		HRToolModelColForm rhs = (HRToolModelColForm) object;
