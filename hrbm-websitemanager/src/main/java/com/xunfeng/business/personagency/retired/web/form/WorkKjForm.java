...
* @Description: 主要工作扣减情况维护 Form对象
* @author:zhangfan
* @createDate 2016-07-23 10:31:59 
* @version V1.0   
*/
public class WorkKjForm extends BaseForm<WorkKj>
{
	// 序号
	protected Long  id;
	// 起始时间
	...
	{
		if (!(object instanceof WorkKjForm)) 
		{
			return false;
		}
		WorkKjForm rhs = (WorkKjForm) object;
