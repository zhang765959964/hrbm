package com.xunfeng.business.personagency.death.web.form;
...
* @Description: 死亡待遇申报 Form对象
* @author:zhangfan
* @createDate 2016-08-26 16:25:11 
* @version V1.0   
*/
public class DeathDeclareForm extends BaseForm<DeathDeclare>
{
	// 主键
	protected Long  id;
	// 人员id
	...
	//人员档案信息
	private DeathPeopleForm deathPeopleForm;
	
	
	
	public DeathPeopleForm getDeathPeopleForm() {
		return deathPeopleForm;
	}
	public void setDeathPeopleForm(DeathPeopleForm deathPeopleForm) {
		this.deathPeopleForm = deathPeopleForm;
	}
	...
	{
		if (!(object instanceof DeathDeclareForm)) 
		{
			return false;
		}
		DeathDeclareForm rhs = (DeathDeclareForm) object;
