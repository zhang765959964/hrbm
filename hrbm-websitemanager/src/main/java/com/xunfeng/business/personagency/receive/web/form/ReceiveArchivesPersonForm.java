...
* @version V1.0   
*/
public class ReceiveArchivesPersonForm 
{
	...
	//家庭成员
	public JiaTingForm jiaTingForm;
	//个人教育背景
	public JiaoYuForm jiaoYuForm;
	...
	public JiaoYuForm getJiaoYuForm() {
		return jiaoYuForm;
	}
	public void setJiaoYuForm(JiaoYuForm jiaoYuForm) {
		this.jiaoYuForm = jiaoYuForm;
	}
	public GongZuoForm getGongZuoForm() {
		return gongZuoForm;
	}
	public JiaTingForm getJiaTingForm() {
		return jiaTingForm;
	}
	public void setJiaTingForm(JiaTingForm jiaTingForm) {
		this.jiaTingForm = jiaTingForm;
	}
