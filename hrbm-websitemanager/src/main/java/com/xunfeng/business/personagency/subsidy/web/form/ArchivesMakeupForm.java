 ...
 * @version V1.0
 */
public class ArchivesMakeupForm extends BaseForm implements Serializable {
	// 主键
	protected Long id;
	/**
	 * 个人基本信息相关字段
	...
	public void setCreaterOrgName(String createrOrgName) {
		...
		this.lendCreaterOrgName = createrOrgName;
		this.lendConfirmOrgName = createrOrgName;
	}

	@Override
	public void setCreaterOrgId(Long createrOrgId) {
		// TODO Auto-generated method stub
		this.lendCreaterOrgId = createrOrgId;
		this.lendConfirmOrgId = createrOrgId;
	}

	@Override
	public void setCreaterId(Long createrId) {
		// TODO Auto-generated method stub
		this.lendCreaterId = createrId;
		this.lendConfirmId = createrId;
	}

	@Override
	public void setCreaterName(String createrName) {
		// TODO Auto-generated method stub
		this.lendCreaterName = createrName;
		this.lendConfirmName = createrName;
	}

	@Override
	public void setCreaterDate(Date createrDate) {
		// TODO Auto-generated method stub
		this.lendCreaterDate = createrDate;
		this.lendConfirmDate = createrDate;
	}
