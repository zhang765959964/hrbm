...
* @Description: 考试报名登记表 Form对象
* @author:jiangxin
* @createDate 2016-09-20 10:13:34 
* @version V1.0   
*/
public class ExaminationRegisterForm extends BaseForm<ExaminationRegister>
{
	// 主键id
	protected Long  id;
	// 档案id
	...
	{
		if (!(object instanceof ExaminationRegisterForm)) 
		{
			return false;
		}
		ExaminationRegisterForm rhs = (ExaminationRegisterForm) object;
