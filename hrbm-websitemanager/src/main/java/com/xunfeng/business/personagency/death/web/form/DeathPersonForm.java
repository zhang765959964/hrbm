...
* @Description: 供养直系亲属情况 Form对象
* @author:zhangfan
* @createDate 2016-08-30 10:12:09 
* @version V1.0   
*/
public class DeathPersonForm extends BaseForm<DeathPerson>
{
	// 主键
	protected Long  id;
	// 死亡外键
	...
	{
		if (!(object instanceof DeathPersonForm)) 
		{
			return false;
		}
		DeathPersonForm rhs = (DeathPersonForm) object;
