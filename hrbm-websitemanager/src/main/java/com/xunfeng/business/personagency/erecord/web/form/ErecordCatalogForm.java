...
* @Description: 电子档案目录 Form对象
* @author:wanghan
* @createDate 2015-08-20 14:29:30 
* @version V1.0   
*/
public class ErecordCatalogForm extends BaseForm<ErecordCatalog>
{
	// 主键
	protected Long  id;
	// 目录名称
	...
	{
		if (!(object instanceof ErecordCatalogForm)) 
		{
			return false;
		}
		ErecordCatalogForm rhs = (ErecordCatalogForm) object;
