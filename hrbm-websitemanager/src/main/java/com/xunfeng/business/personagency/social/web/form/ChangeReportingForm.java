...
* @Description: 个人社保变更申报记录表 Form对象
* @author:jiangxin
* @createDate 2016-08-11 09:36:03 
* @version V1.0   
*/
public class ChangeReportingForm extends BaseForm<ChangeReporting>
{
	// 主键ID
	protected Long  id;
	// 档案id
	...
	{
		if (!(object instanceof ChangeReportingForm)) 
		{
			return false;
		}
		ChangeReportingForm rhs = (ChangeReportingForm) object;
