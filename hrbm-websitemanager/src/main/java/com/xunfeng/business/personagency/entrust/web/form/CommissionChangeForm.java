package com.xunfeng.business.personagency.entrust.web.form;
...
* @Description: 委托类型变更 Form对象
* @author:jiangxin
* @createDate 2016-08-23 10:03:50 
* @version V1.0   
*/
public class CommissionChangeForm extends BaseForm<CommissionChange>
{
	// 主键
	protected Long  id;
	// 变更类型
	...
	// 变更委托单位名称
	protected String  commissionCorpNameNot;
	protected Long  aab001not;
	
	
	
	
	public Long getAab001not() {
		return aab001not;
	}
	public void setAab001not(Long aab001not) {
		this.aab001not = aab001not;
	}
	public String getCommissionCorpNameNot() {
		return commissionCorpNameNot;
	}
	public void setCommissionCorpNameNot(String commissionCorpNameNot) {
		this.commissionCorpNameNot = commissionCorpNameNot;
	}
	...
	{
		if (!(object instanceof CommissionChangeForm)) 
		{
			return false;
		}
		CommissionChangeForm rhs = (CommissionChangeForm) object;
