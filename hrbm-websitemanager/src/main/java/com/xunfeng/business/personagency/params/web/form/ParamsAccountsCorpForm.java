...
* @Description: 账号与市场关联维护 Form对象
* @author:wanghan
* @createDate 2016-09-07 10:24:43 
* @version V1.0   
*/
public class ParamsAccountsCorpForm extends BaseForm<ParamsAccountsCorp>
{
	// 主键
	protected Long  pkId;
	// 用户帐号
	...
	{
		if (!(object instanceof ParamsAccountsCorpForm)) 
		{
			return false;
		}
		ParamsAccountsCorpForm rhs = (ParamsAccountsCorpForm) object;
