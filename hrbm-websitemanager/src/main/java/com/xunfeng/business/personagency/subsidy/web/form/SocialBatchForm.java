...
* @Description: RSDA_BS_SOCIAL_BATCH Form对象
* @author:wanghan
* @createDate 2016-07-07 09:12:59 
* @version V1.0   
*/
public class SocialBatchForm extends BaseForm<SocialBatch>
{
	// 主键
	protected Long  id;
	// 批次名称
	...
	{
		if (!(object instanceof SocialBatchForm)) 
		{
			return false;
		}
		SocialBatchForm rhs = (SocialBatchForm) object;
