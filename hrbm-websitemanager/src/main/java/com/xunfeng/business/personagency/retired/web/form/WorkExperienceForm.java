...
* @Description: 主要工作经历维护 Form对象
* @author:zhangfan
* @createDate 2016-07-22 15:23:26 
* @version V1.0   
*/
public class WorkExperienceForm extends BaseForm<WorkExperience>
{
	// 序号
	protected Long  id;
	// 起始时间
	...
	{
		if (!(object instanceof WorkExperienceForm)) 
		{
			return false;
		}
		WorkExperienceForm rhs = (WorkExperienceForm) object;
