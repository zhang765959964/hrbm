 ...
 * @version V1.0
 */
public class SocialCorpDeclareForm extends BaseForm<SocialCorpDeclare> {
	// 主键
	protected Long id;
	// 养老保险补贴人数
	...
	public boolean equals(Object object) {
		if (!(object instanceof SocialCorpDeclareForm)) {
			return false;
		}
		SocialCorpDeclareForm rhs = (SocialCorpDeclareForm) object;
