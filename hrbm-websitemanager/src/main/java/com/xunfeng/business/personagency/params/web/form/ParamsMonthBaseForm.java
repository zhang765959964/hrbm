...
* @Description: 月缴费基数 Form对象
* @author:wanghan
* @createDate 2016-09-07 09:23:00 
* @version V1.0   
*/
public class ParamsMonthBaseForm extends BaseForm<ParamsMonthBase>
{
	// 主键
	protected Long  pkId;
	// 月缴费基数
	...
	{
		if (!(object instanceof ParamsMonthBaseForm)) 
		{
			return false;
		}
		ParamsMonthBaseForm rhs = (ParamsMonthBaseForm) object;
