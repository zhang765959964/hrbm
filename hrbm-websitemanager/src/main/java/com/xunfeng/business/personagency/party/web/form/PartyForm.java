...
public class PartyForm extends BaseForm<Party>
{
	...
	protected java.util.Date lastPartyDate; //党员最后一次缴费记录
	
	
	protected PartyPersonForm partyPersonForm;	//个人基本档案信息
	...
	{
		if (!(object instanceof PartyForm)) 
		{
			return false;
		}
		PartyForm rhs = (PartyForm) object;
		...
		.append(this.lastPartyDate, lastPartyDate)
		.isEquals();
	}
	...
	public PartyPersonForm getPartyPersonForm() {
		return partyPersonForm;
	}
	public void setPartyPersonForm(PartyPersonForm partyPersonForm) {
		this.partyPersonForm = partyPersonForm;
	}
