 ...
 * @Description: 退休人员大病医保表 Form对象
 * @author:zhangfan
 * @createDate 2016-12-16 11:23:41
 * @version V1.0
 */
public class RetiredCareForm extends BaseForm<RetiredCare> {
	...
	private String archiveStatusName;	//存档状态
	
	private RetiredPersonCareForm retiredPersonCareForm;
	...
	public RetiredPersonCareForm getRetiredPersonCareForm() {
		return retiredPersonCareForm;
	}

	public void setRetiredPersonCareForm(RetiredPersonCareForm retiredPersonCareForm) {
		this.retiredPersonCareForm = retiredPersonCareForm;
	}
