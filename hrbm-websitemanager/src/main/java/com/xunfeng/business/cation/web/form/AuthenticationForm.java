package com.xunfeng.business.cation.web.form;
...
* @Description: 网上认证提交信息表 Form对象
* @author:wanghan
* @createDate 2015-11-11 18:17:38 
* @version V1.0   
*/
public class AuthenticationForm extends BaseForm<Authentication>
{
	// 认证提交自动编号
	...
	{
		if (!(object instanceof AuthenticationForm)) 
		{
			return false;
		}
		AuthenticationForm rhs = (AuthenticationForm) object;
