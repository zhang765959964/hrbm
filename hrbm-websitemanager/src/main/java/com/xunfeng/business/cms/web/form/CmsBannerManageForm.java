...
* @Description: 栏目板块管理 比如快速栏目中的前十个信息名称 Form对象
* @author:wanghan
* @createDate 2016-03-22 16:46:24 
* @version V1.0   
*/
public class CmsBannerManageForm extends BaseForm<CmsBannerManage>
{
	// 主键ID
	protected Long  id;
	// 信息ID
	...
	{
		if (!(object instanceof CmsBannerManageForm)) 
		{
			return false;
		}
		CmsBannerManageForm rhs = (CmsBannerManageForm) object;
