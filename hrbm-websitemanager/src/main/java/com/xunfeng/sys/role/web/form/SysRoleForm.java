package com.xunfeng.sys.role.web.form;
...
* @Description: 角色表 Form对象
* @author:liwenhao
* @createDate 2016-06-22 10:30:54 
* @version V1.0   
*/
public class SysRoleForm extends BaseForm<SysRole>
{
	 ...
	 * sid
	 */
	private static final long serialVersionUID = -5410261068657433142L;
	// 角色编号
	...
	{
		if (!(object instanceof SysRoleForm)) 
		{
			return false;
		}
		SysRoleForm rhs = (SysRoleForm) object;
