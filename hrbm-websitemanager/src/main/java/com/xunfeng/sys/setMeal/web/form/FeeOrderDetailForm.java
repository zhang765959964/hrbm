...
* @Description: 套餐订购详表 Form对象
* @author:
* @createDate 2016-07-19 09:19:03 
* @version V1.0   
*/
public class FeeOrderDetailForm extends BaseForm<FeeOrderDetail>
{
	// 详单流水
	...
	{
		if (!(object instanceof FeeOrderDetailForm)) 
		{
			return false;
		}
		FeeOrderDetailForm rhs = (FeeOrderDetailForm) object;
