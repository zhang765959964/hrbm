...
* @Description: 服务细项表 Form对象
* @author:wangyanyan
* @createDate 2016-07-19 09:11:01 
* @version V1.0   
*/
public class FeeServCfgForm extends BaseForm<FeeServCfg>
{
	// 细项代码
	...
	{
		if (!(object instanceof FeeServCfgForm)) 
		{
			return false;
		}
		FeeServCfgForm rhs = (FeeServCfgForm) object;
