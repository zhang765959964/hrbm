...
* @Description: 消费使用流水表 Form对象
* @author:
* @createDate 2016-07-19 09:22:45 
* @version V1.0   
*/
public class FeeUseDetailForm extends BaseForm<FeeUseDetail>
{
	// 使用流水
	...
	{
		if (!(object instanceof FeeUseDetailForm)) 
		{
			return false;
		}
		FeeUseDetailForm rhs = (FeeUseDetailForm) object;
