package com.xunfeng.sys.attachment.web.form;
...
* @version V1.0   
*/
public class AttachmentForm extends BaseForm<Attachment>
{
	// 认证提交自动编号
	...
	{
		if (!(object instanceof AttachmentForm)) 
		{
			return false;
		}
		AttachmentForm rhs = (AttachmentForm) object;
