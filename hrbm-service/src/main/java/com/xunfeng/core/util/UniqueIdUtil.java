...
public class UniqueIdUtil {
	...
	private static  void getNextIdBlock() {
		...
		String sql="SELECT bound,incremental FROM RSDA_SYS_DB_ID T WHERE T.ID=?";
		String upSql="UPDATE RSDA_SYS_DB_ID  SET BOUND=? WHERE ID=?";
		try{
	...
	private static void insertNewComputer(){
		try{
			lastId = 10000;
			String sql="INSERT INTO RSDA_SYS_DB_ID (id,incremental,bound) VALUES("+adjust+",10000,"+lastId+")";
