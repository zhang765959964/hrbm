package com.xunfeng.sys.statistics.model;
 ...
 * 创建时间:2015-04-30 09:51:03
 */
public class SysStatistics extends BaseModel implements IBaseTree
{
	/**
	 * sid
	 */
	...
	{
		if (!(object instanceof SysStatistics)) 
		{
			return false;
		}
		SysStatistics rhs = (SysStatistics) object;
