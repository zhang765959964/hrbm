 ...
 */
public class SysRegistered extends BaseModel
{
	// 用户信息表自动编号
	...
	// 账号状态(1-有效账号2-无效账号3-已审验未完善4-禁止登陆5-仅职介中心市场可用)
	...
	/**
	 * 返回 账号状态(1-有效账号2-无效账号3-已审验未完善4-禁止登陆5-仅职介中心市场可用)
	 * @return
	 */
	...
	{
		if (!(object instanceof SysRegistered)) 
		{
			return false;
		}
		SysRegistered rhs = (SysRegistered) object;
