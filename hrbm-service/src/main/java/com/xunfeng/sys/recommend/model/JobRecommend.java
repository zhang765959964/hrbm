package com.xunfeng.sys.recommend.model;
...
* @version V1.0   
*/
public class JobRecommend extends BaseModel
{
	// 推荐编号
	...
	{
		if (!(object instanceof JobRecommend))
		{
			return false;
		}
		JobRecommend rhs = (JobRecommend) object;
