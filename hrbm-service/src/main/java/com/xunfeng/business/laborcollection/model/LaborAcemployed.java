...
* @Description: 未就业及失业情况信息表 Model对象
* @author:wangyanyan
* @createDate 2016-06-24 11:56:58 
* @version V1.0   
*/
public class LaborAcemployed extends BaseModel
{
	// 就业失业ID
	...
	{
		if (!(object instanceof LaborAcemployed)) 
		{
			return false;
		}
		LaborAcemployed rhs = (LaborAcemployed) object;
