...
public class PersonEducation extends BaseModel
{
	...
	public Long getDiv001() 
	{
   	...
   	public String getAac0d6name() {
		return this.aac0d6name;
	}
	public void setAac0d6name(String aac0d6name) {
		this.aac0d6name = aac0d6name;
	}
	/**
	...
	public boolean equals(Object object)
	{
		...
		PersonEducation rhs = (PersonEducation) object;
		...
		.append(this.aac0d6name, rhs.aac0d6name)
		.isEquals();
	}
	...
	public String toString() 
	{
		...
		.append("aac0d6name", this.aac0d6name) 
		.toString();
	}
