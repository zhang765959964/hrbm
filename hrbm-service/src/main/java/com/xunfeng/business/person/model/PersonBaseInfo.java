...
public class PersonBaseInfo extends BaseModel
{
	...
	// 简历完成百分比
	protected Long  ccmu50=0L;
	// 求职意向是否完整
	protected String  ccmu51="0";
	// 技能特长是否完整 
	protected String  ccmu52="0";
	// 教育经历是否完整
	protected String  ccmu53="0";
	// 工作经历 是否完整
	protected String  ccmu54="0";
	// 形象照片是否完整
	protected String  ccmu55="0";
	// 头像是否显示
	protected String  ccmu56="0";
	// 数据来源（0-未知1-网站2-窗口3-民营机构4-公办机构5-导入数据）
	protected String  cczy06;
	// 培训经历是否完整
	protected String  ccmu57="0";
	// 认证标志（0-未认证1-已上传未认证2-网站后台认证3-职介人工认证4-设备认证）
	protected Long  ccmu58=0L;
	// 手机认证标志（0-未认证1-已发送未认证2-手机已认证)
	protected Long  ccmu59=0L;
	// 邮件认证标志（0-未认证1-已发送未认证2-邮件已认证)
	protected Long  ccmu60=0L;
	// 身份证头像
...
//	}
	public Long getAge() {
		if(this.aac006!=null && !this.aac006.equals("")){
			age =(new Date().getTime() - this.aac006.getTime())/(1000*60*60*24)/365;
		}
		return age;
	}
	...
	{
		if (!(object instanceof PersonBaseInfo))
		{
			return false;
		}
		PersonBaseInfo rhs = (PersonBaseInfo) object;
