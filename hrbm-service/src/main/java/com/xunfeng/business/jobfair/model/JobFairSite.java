...
* @Description: 场地表 Model对象
* @author:wanghan
* @createDate 2015-09-12 11:18:57 
* @version V1.0   
*/
public class JobFairSite extends BaseModel
{
	// 场地编号
	...
	public void setCczc002(String cczc002) 
	{
		this.cczc002 = cczc002;
	}
	/**
	 * 返回 模板路径
	 * @return
	 */
	public String getCczc002() 
	{
		return this.cczc002;
	}
	...
	public void setCczc007(String cczc007) 
	{
		this.cczc007 = cczc007;
	}
	/**
	 * 返回 使用状态(0-正常使用1-已注销)
	 * @return
	 */
	public String getCczc007() 
	{
		return this.cczc007;
	}
	...
	{
		if (!(object instanceof JobFairSite)) 
		{
			return false;
		}
		JobFairSite rhs = (JobFairSite) object;
		...
		.append(this.cczc001, rhs.cczc001)
		.append(this.cczc002, rhs.cczc002)
		...
		.append(this.cczc007, rhs.cczc007)
