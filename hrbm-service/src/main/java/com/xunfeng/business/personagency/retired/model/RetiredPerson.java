...
* @Description: RSDA_BS_RETIRED_PERSON Model对象
* @author:zhangfan
* @createDate 2016-08-02 17:12:13 
* @version V1.0   
*/
public class RetiredPerson extends BaseModel
{
	// 主键
	protected Long  id;
	// 退休状态（0 否1 是）
	...
	{
		if (!(object instanceof RetiredPerson)) 
		{
			return false;
		}
		RetiredPerson rhs = (RetiredPerson) object;
