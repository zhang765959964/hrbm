...
* @Description: RSDA_BS_PAYMENT_CORP_RECORD Model对象
* @author:wanghan
* @createDate 2016-08-20 14:57:53 
* @version V1.0   
*/
public class PaymentCorpRecord extends BaseModel
{
	// 主键ID
	protected Long  pkId;
	// 人员ID
	...
	protected DerateStatus fdDerateStatus;
	...
	public String getFdConfirmsOrgName() 
	{
   	...
   	public DerateStatus getFdDerateStatus() {
		return fdDerateStatus;
	}
	public void setFdDerateStatus(DerateStatus fdDerateStatus) {
		this.fdDerateStatus = fdDerateStatus;
	}
	...
	{
		if (!(object instanceof PaymentCorpRecord)) 
		{
			return false;
		}
		PaymentCorpRecord rhs = (PaymentCorpRecord) object;
