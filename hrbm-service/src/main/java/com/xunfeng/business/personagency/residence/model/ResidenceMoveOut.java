package com.xunfeng.business.personagency.residence.model;
...
* @Description: 户口迁入迁出表 Model对象
* @author:jiangxin
* @createDate 2016-08-27 15:36:07 
* @version V1.0   
*/
public class ResidenceMoveOut extends BaseModel
{
	// 主键id
	protected Long  id;
	// 档案id
	...
	{
		if (!(object instanceof ResidenceMoveOut)) 
		{
			return false;
		}
		ResidenceMoveOut rhs = (ResidenceMoveOut) object;
