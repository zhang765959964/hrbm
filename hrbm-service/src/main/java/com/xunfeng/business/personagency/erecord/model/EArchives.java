...
* @Description: 电子档案表 Model对象
* @author:wanghan
* @createDate 2015-08-10 17:34:17 
* @version V1.0   
*/
public class EArchives extends BaseModel
{
	// 主键
	protected Long  id;
	// 目录Id
	...
	{
		if (!(object instanceof EArchives)) 
		{
			return false;
		}
		EArchives rhs = (EArchives) object;
