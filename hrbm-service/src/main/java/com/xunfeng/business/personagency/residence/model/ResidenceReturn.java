...
* @Description: 户口借用归还表 Model对象
* @author:jiangxin
* @createDate 2016-08-30 10:37:00 
* @version V1.0   
*/
public class ResidenceReturn extends BaseModel
{
	// 主键id
	protected Long  id;
	// 档案id
	...
	{
		if (!(object instanceof ResidenceReturn)) 
		{
			return false;
		}
		ResidenceReturn rhs = (ResidenceReturn) object;
