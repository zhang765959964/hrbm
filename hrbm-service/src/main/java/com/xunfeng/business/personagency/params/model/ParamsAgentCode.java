...
* @Description: 劳动代理代码维护 Model对象
* @author:wanghan
* @createDate 2016-09-07 10:24:17 
* @version V1.0   
*/
public class ParamsAgentCode extends BaseModel
{
	// 主键
	protected Long  pkId;
	// 代码类别
	...
	{
		if (!(object instanceof ParamsAgentCode)) 
		{
			return false;
		}
		ParamsAgentCode rhs = (ParamsAgentCode) object;
