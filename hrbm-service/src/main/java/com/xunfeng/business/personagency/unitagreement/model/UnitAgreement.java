package com.xunfeng.business.personagency.unitagreement.model;
 ...
 * @Description: 单位协议表 Model对象
 * @author:zhangfan
 * @createDate 2016-07-06 12:11:01
 * @version V1.0
 */
public class UnitAgreement extends BaseModel {
	// 主键
	protected Long id;
	// 单位协议编号
	...
	public boolean equals(Object object) {
		if (!(object instanceof UnitAgreement)) {
			return false;
		}
		UnitAgreement rhs = (UnitAgreement) object;
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.stopDatexx, rhs.stopDatexx).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.uaNo).append(this.uaCreatetime)
				.append(this.uaName).append(this.uaPhone).append(this.uaIsFree)
				.append(this.uaCard).append(this.uaContent).append(this.uaNote)
				.append(this.uaStopEndtime).append(this.uaStopCause)
				.append(this.uaUnitId).append(this.createrId)
				.append(this.createrName).append(this.createrDate)
				.append(this.createrOrgId).append(this.createrOrgName)
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("uaName", this.uaName).append("uaPhone", this.uaPhone)
				...
				.append("aab004", this.aab004).append("aab001", this.aab001)
				.append("stopDate", this.stopDate)
				.append("stopDatexx", this.stopDatexx).toString();
	}
