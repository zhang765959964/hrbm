package com.xunfeng.business.personagency.storage.model;
...
* @Description: 特殊档案表 Model对象
* @author:jiangxin
* @createDate 2016-08-15 14:27:06 
* @version V1.0   
*/
public class SpecialArchives extends BaseModel
{
	// 主键
	protected Long  id;
	// 姓名
	...
	{
		if (!(object instanceof SpecialArchives)) 
		{
			return false;
		}
		SpecialArchives rhs = (SpecialArchives) object;
