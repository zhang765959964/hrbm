...
* @Description: RSDA_BS_PARAMS_PAYMENT Model对象
* @author:wanghan
* @createDate 2016-09-05 09:47:42 
* @version V1.0   
*/
public class ParamsPayment extends BaseModel
{
	// 主键ID
	protected Long  pkId;
	// 标准执行开始年月
	...
	{
		if (!(object instanceof ParamsPayment)) 
		{
			return false;
		}
		ParamsPayment rhs = (ParamsPayment) object;
		return new EqualsBuilder()
		.append(this.pkId, rhs.pkId)
		.append(this.fdStartdate, rhs.fdStartdate)
		.append(this.fdEnddate, rhs.fdEnddate)
		.append(this.fdStandard, rhs.fdStandard)
		.append(this.fdDiscountStandard, rhs.fdDiscountStandard)
	...
	public int hashCode() 
	{
		...
		.append(this.fdStandard) 
		.append(this.fdDiscountStandard) 
	...
	public String toString() 
	{
		...
		.append("fdStandard", this.fdStandard) 
		.append("fdDiscountStandard", this.fdDiscountStandard) 
