...
* @Description: 档案借阅记录表 Model对象
* @author:jiangxin
* @createDate 2016-09-02 15:56:41 
* @version V1.0   
*/
public class ArchiveCheckout extends BaseModel
{
	// 主键ID
	protected Long  id;
	// 档案Id
	...
	/**
	 * 返回 扣押材料（rsda_tab_SEIZUREMATERIAL）
	 * @return
	 */
	...
	{
		if (!(object instanceof ArchiveCheckout)) 
		{
			return false;
		}
		ArchiveCheckout rhs = (ArchiveCheckout) object;
