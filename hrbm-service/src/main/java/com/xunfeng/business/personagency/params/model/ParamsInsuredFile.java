...
* @Description: 参保文件 Model对象
* @author:wanghan
* @createDate 2016-09-07 10:23:40 
* @version V1.0   
*/
public class ParamsInsuredFile extends BaseModel
{
	// 主键
	protected Long  pkId;
	// 文件名称
	...
	{
		if (!(object instanceof ParamsInsuredFile)) 
		{
			return false;
		}
		ParamsInsuredFile rhs = (ParamsInsuredFile) object;
