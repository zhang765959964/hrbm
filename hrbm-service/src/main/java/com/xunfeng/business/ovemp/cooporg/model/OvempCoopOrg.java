package com.xunfeng.business.ovemp.cooporg.model;
 ...
 */
public class OvempCoopOrg extends BaseModel implements IBaseTree,Serializable
{
	/**
	 * sid
	 */
	...
	protected String jco005;
	protected String jco006;
	// 申请业务范围
...
//	protected String  name;
	...
	public String getJco005() {
		return jco005;
	}
	public void setJco005(String jco005) {
		this.jco005 = jco005;
	}
	public String getJco006() {
		return jco006;
	}
	public void setJco006(String jco006) {
		this.jco006 = jco006;
	}
	/**
	 * 返回 住址
	...
	{
		if (!(object instanceof OvempCoopOrg)) 
		{
			return false;
		}
		OvempCoopOrg rhs = (OvempCoopOrg) object;
