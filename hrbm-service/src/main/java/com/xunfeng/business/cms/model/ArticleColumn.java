...
public class ArticleColumn extends BaseModel
{
	...
	// 类别路径
	protected String  canc12;
	// 排序号
	protected Long  canc13;
	List<ArticleColumn> childColList=new ArrayList<ArticleColumn>();
	...
	public void setCanc12(String canc12) 
	{
		this.canc12 = canc12;
	}
	/**
	...
	public List<ArticleColumn> getChildColList() {
		return childColList;
	}

	public void setChildColList(List<ArticleColumn> childColList) {
	...
	{
		if (!(object instanceof ArticleColumn)) 
		{
			return false;
		}
		ArticleColumn rhs = (ArticleColumn) object;
