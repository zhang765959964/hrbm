...
import com.xunfeng.business.train.dao.TrainCourseDao;
...
*/
@Service
public class TrainCourseService extends BaseService<TrainCourse> implements TrainCourseServiceInterf
{
	@Resource
	...
	public TrainCourseService()
	{
	}
	
	@Override
	protected IEntityDao<TrainCourse, Long> getEntityDao() 
	{
		return dao;
	}
	...
	@Override
	public TrainCourse getCourseById(Long courseId) {
		return dao.getById(courseId);
	}

	@Override
	public void updateCourse(TrainCourse trainCourse) {
		dao.update(trainCourse);
	}
	/**
	 * 个人中心获得培训课程
	 * @param pageBean 分页显示
	...
	@Override
	public ResultData<TrainCourse> getAllTrainCourse(QueryFilter fiter) {
		
		ResultData<TrainCourse> resultData=new ResultData<TrainCourse>();
		List<TrainCourse> dataList =dao.getAll(fiter);
		resultData.setDataList(dataList);
		resultData.setPageBean(fiter.getPageBean());
		return resultData;
	}
	...
	@Override
	public TrainCourse getCourseByName(String courseName) {
