package com.xunfeng.business.dissupport.jobmatch.model;
...
* @Description: 求职推荐匹配表 Model对象
* @author:wanghan
* @createDate 2016-08-15 20:00:42 
* @version V1.0   
*/
public class PersonJobRecommend extends BaseModel
{
	// 推荐编号
	...
	//是否发送短信
	protected String  ismessge;
	
	public String getIsmessge() {
		return ismessge;
	}
	public void setIsmessge(String ismessge) {
		this.ismessge = ismessge;
	}
	...
	{
		if (!(object instanceof PersonJobRecommend)) 
		{
			return false;
		}
		PersonJobRecommend rhs = (PersonJobRecommend) object;
